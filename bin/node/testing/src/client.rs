...
//! Utilities to build a `TestClient` for `node-peer-runtime`.
...
/// Call executor for `node-peer-runtime` `TestClient`.
...
pub type Client = client::Client<
	...
	node_peer_runtime::RuntimeApi,
>;

/// Transaction for node-peer-runtime.
