...
parameter_types! {
	...
	pub const SlashDeferDuration: sp_staking::EraIndex = 6 * 7; // 1/4 the bonding duration.
	pub const RewardCurve: &'static PiecewiseLinear<'static> = &REWARD_CURVE;
	pub const MaxNominatorRewardedPerValidator: u32 = 350;
